  ...
  theme: {
    extend: {
      ...
      content: {
        ...
        person7: "url('./assets/elka.avif')",
        person8: "url('./assets/3.avif')",
        person9: "url('./assets/mir.avif')",
        ...
        person16: "url('./assets/iwett.avif')",
        person17: "url('./assets/dorota.avif')",
        person18: "url('./assets/lidia.avif')",
        person19: "url('./assets/zofia.avif')",
        person20: "url('./assets/user.avif')",
      },
    },
    screens: {
      xs: "480px",
